...
<head>
    ...
    <!-- PAGE TITLE -->
    <title>OTP Verification | JourneyWheels | Bike Rental Services</title>
   ...
   ?>
    ...
    <section class="bookcab " id="bookcab" style="padding:80px 0;margin-top:50px;" >
                    ...
                    <div class="col-md-7">
                        <div class="panel panel-default sidebar-menu" style="box-shadow: 0 2px 2px 0 rgba(0,0,0,0.14), 0 1px 5px 0 rgba(0,0,0,0.12), 0 3px 1px -2px rgba(0,0,0,0.2);"><!-- panel panel-default sidebar-menu Starts -->
                           <div class="panel-heading text-center" style="background:#ffb735;">
                                <h5 id='p_title' >ENTER THE OTP</h5>
                            </div>
                             <div class="panel-body customeracnt" >
				<form class="log" method="post" action="">
									<div class="form-group  is-empty">
                      <label>OTP *</label>
                      <input type="text" class="form-control" minlength="6" maxlength="6" placeholder="Enter OTP" name="otp" style="border-radius:5px; height:35px;background:#f6f6f6" required="required">
                  </div>
        ...
        if(isset($_POST['verify'])) 
        {
          ...
          if ($otp==$_SESSION["otp"]) 
          {
             echo "<script>alert('Congrats!! Your Mobile Number is Verified!!')
