...
<head>
    ...
    <!-- PAGE TITLE -->
    <title>We're Hiring | Bike Rentals | Rent a Bike</title>
...
<div id="wide-desktop">
   ...
   ?>
    ...
    <section  id="bookcab"  >
                         ...
                         <img src="images/IMG_3305.jpg" style="height:610px;">
                    <h2 class="text-center"><b>Send Us your resume at</b></h2>
                    <h4 class="text-center"><b>Contact@journeywheels.in</b></h4>
                
                      <h4 class="text-center"><b>Test@journeywheels.in</b></h4>
    </section>
      ...
      <div class="modal-body">
         <form class="log" id="registFrm" method="post">
                ...
                <div class="form-group regphn">
                    ...
                    <input type="text" class="form-control" name="rmobile"  maxlength="10" pattern="[789][0-9]{9}" title="Mobile no. should be 10 digit & start with 7,8,9" minlength="10" maxlength="10" placeholder="Mobile Number" style="border: 1px solid black" required="required">
                </div>
