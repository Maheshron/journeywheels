...
$get_car_orders = "select * from cars_orders";
$run_car_orders = mysqli_query($con,$get_car_orders);
$count_cars_orders = mysqli_num_rows($run_car_orders);

$get_bicycle_orders = "select * from bicycles_orders";
$run_bicycle_orders = mysqli_query($con,$get_bicycle_orders);
$count_bicycles_orders = mysqli_num_rows($run_bicycle_orders);
...
<div class="container-fluid" style="padding-top:20px;"><!-- container-fluid Starts -->
...
if(isset($_GET['bike_all_orders'])){

include("bike_all_orders.php");

}
if(isset($_GET['car_all_orders'])){

include("car_all_orders.php");

}
if(isset($_GET['bicycle_all_orders'])){

include("bicycle_all_orders.php");

}
if(isset($_GET['insert_bicycle'])){

include("insert_bicycle.php");

}

if(isset($_GET['view_bicycles'])){

include("view_bicycles.php");
...
if(isset($_GET['cars_orders'])){

include("cars_orders.php");

}

if(isset($_GET['bicycles_orders'])){

include("bicycles_orders.php");
...
if(isset($_GET['edit_bicycle'])){

include("edit_bicycle.php");

}

if(isset($_GET['delete_bicycleproduct'])){

include("delete_bicycleproduct.php");
...
if(isset($_GET['delete_carproduct'])){

include("delete_carproduct.php");

}

if(isset($_GET['manage_bikes'])){

include("manage_bikes.php");

}
if(isset($_GET['manage_bicycles'])){

include("manage_bicycles.php");

}
if(isset($_GET['manage_cars'])){

include("manage_cars.php");

}
if(isset($_GET['edit_manage_bike'])){

include("edit_manage_bike.php");

}
if(isset($_GET['edit_manage_car'])){

include("edit_manage_car.php");

}
if(isset($_GET['edit_manage_bicycle'])){

include("edit_manage_bicycle.php");
