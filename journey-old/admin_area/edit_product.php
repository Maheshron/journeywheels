           ...
           <div class="panel panel-default"><!-- panel panel-default Starts -->
                ...
                <div class="panel-heading"><!-- panel-heading Starts -->
                    ...
                    <h3 class="panel-title">
                        ...
                        <i class="fa fa-money fa-fw"></i> Edit Bikes
                ...
                <div class="panel-body"><!-- panel-body Starts -->
                           ...
                           <form class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                               ...
                               <div class="form-group" ><!-- form-group Starts -->
                                    ...
                                    <label class="col-md-3 control-label" > Bike Location* </label>
                               ...
                               <div class="form-group" ><!-- form-group Starts -->
                                    ...
                                    <label class="col-md-3 control-label" > Bike Availability* </label>
...
$update_product = "update products set product_title='$product_title',product_img='$product_img',price='$product_price',location='$u_loc',availability='$u_available',cat_id='$u_cat_id' where id='$p_id'";
