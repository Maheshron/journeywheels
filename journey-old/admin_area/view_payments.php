...
$get_pro = "select * from customers_orders ORDER BY id DESC LIMIT $start_from, $limit";
...
$pick_datatime = $row_pro['pick_datatime'];
...
<div class="col-md-12 col-xs-12 col-sm-12 text-center">
                                <?php
                                $sql = "SELECT COUNT(id) FROM customers_orders ";
                                ...
                                for ($i = 1; $i <= $total_pages; $i++) {
                                    ...
                                    $pagLink .= "<li class='page-item $c'><a class='page-link ' style='margin-left:5px' href='index.php?view_payments&page=" . $i . "'>" . $i . "</a></li>";
                                };
                                echo $pagLink . "</ul>";
                                ...
                                echo "<script type='text/javascript'>
                                            $(document).ready(function(){
                                                $('.pagination').pagination({
                                                    ...
                                                    currentPage : $page,
                                                    hrefTextPrefix : 'index.php?view_payments&page='
                                                });
                                            });
                                        </script>";
