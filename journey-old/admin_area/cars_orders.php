...
<i class="fa fa-dashboard"></i> Dashboard / Cars Order Management
...
<i class="fa fa-money fa-fw"></i> Cars Order Management
...
$get_pro = "select * from cars_orders where location='$id' ORDER BY id DESC LIMIT $start_from, $limit";
...
<div class="col-md-12 col-xs-12 col-sm-12 text-center">
                                <?php
                                $sql = "SELECT COUNT(id) FROM cars_orders where location='$id' ";
                                ...
                                for ($i = 1; $i <= $total_pages; $i++) {
                                    ...
                                    $pagLink .= "<li class='page-item $c'><a class='page-link ' style='margin-left:5px' href='index.php?cars_orders=" . $id . "&page=" . $i . "'>" . $i . "</a></li>";
                                };
                                echo $pagLink . "</ul>";
                                ...
                                echo "<script type='text/javascript'>
                                            $(document).ready(function(){
                                                $('.pagination').pagination({
                                                    ...
                                                    currentPage : $page,
                                                    hrefTextPrefix : 'index.php?cars_orders=" . $id . "&page='
                                                });
                                            });
                                        </script>";
