...
$edit_id = $_GET['edit_bicycle'];

$get_p = "select * from bicycles where id='$edit_id'";
...
<i class="fa fa-dashboard"> </i> Dashboard / Edit Bi-Cycles
...
<i class="fa fa-money fa-fw"></i> Edit Bi-Cycles
...
<label class="col-md-3 control-label" > Bi-Cycle Title </label>
...
<input type="text" name="product_title" class="form-control" required value="<?php echo $p_title; ?>">
 ...
 <div class="form-group" ><!-- form-group Starts -->
                                    ...
                                    <label class="col-md-3 control-label" > Bi-Cycle Type * </label>
<div class="col-md-6" >
                                    <select type="text" name="p_mainparent" class="form-control" required >
                <option value="">Select Bi-Cycle Type</option>
...
<label class="col-md-3 control-label" > Bi-Cycle Image  </label>
...
<label class="col-md-3 control-label" > Bi-Cycle Price </label>
...
<input type="text" name="product_price" class="form-control" required value="<?php echo $p_price; ?>" >
 ...
 <div class="form-group" ><!-- form-group Starts -->
                                    ...
                                    <label class="col-md-3 control-label" > Bi-Cycle Location* </label>
<div class="col-md-6" >
  ...
  <div class="form-group" ><!-- form-group Starts -->
                                    ...
                                    <label class="col-md-3 control-label" >Bi-Cycle Availability* </label>
<div class="col-md-6" >
...
$update_product = "update bicycles set product_title='$product_title',product_img='$product_img',price='$product_price',location='$u_loc',availability='$u_available',cat_id='$u_cat_id' where id='$p_id'";
...
echo "<script>window.open('index.php?view_bicycles','_self')</script>";
