...
<div id="wide-desktop">
    ...
    <section class="bookcab padding-80" id="bookcab" style="margin-top:50px" >
        <div class="container">
            <div class="row">
               <div class="col-lg-1 col-md-1  col-xs-12 styl_pd"></div>
               <div class="col-lg-6 col-md-6 col-sm-7 col-xs-12 styl_pd">
                   <div class="card"  id="card_check" >
                    ...
                    <div class="row" >
                       ...
                       <form action="booking1.php?pickaddress=<?php echo $ploc; ?>&dropaddress=<?php echo $dloc; ?>&id=<?php echo $id; ?>&pickdatetime=<?php echo $pickupdatetime; ?>&dropdatetime=<?php echo $dropdatetime; ?>&helid=2&location=<?php echo $location; ?>" method="POST">
               ...
               <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12 styl_pd">
                     <div class="card" id="card_check">
