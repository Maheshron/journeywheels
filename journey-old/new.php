...
<div id="wide-desktop">
            ...
            <div class="row">
                ...
                <div class="col-md-5 padding40 wow fadeInRight introDiv hidden-xs" data-wow-duration="0.8s" data-wow-delay="0.5s">
                    <div class="short-intro">
                        ...
                        <p align="justify">Journey Wheels offers the simplest, easiest car and bike rental tariff in Vijayawada,Tirupati & Nellore. Find out with us and Find cheap rent a car and bike deals with journeywheels Compare and save big on your next trip with discount Journey Wheels car and bike rentals today.  </p>
	                                                    ...
	                                                    <div class="mini-packages col-sm-12" style="padding-bottom:20px" >
                                                            <div class="col-sm-1  mr-2  "></div>
                                                               <div class="col-sm-3 col-xs-4 mr-2  " data-wow-duration="0.8s" data-wow-    delay="1.3s">
                                                                    <div class="pkg-item text-center <?php if(isset($_POST['package'])){
                                                                        $c=$_POST['package'];
                                                                        if($c==1){
                                                                            echo 'active';
                                                                        }
                                                          ...
                                                          <div class="col-md-6 col-sm-6">
                                                              <div class="form-group">
                                                                 <div class="form-control-wrapper">
                                                                     <input type="text" id="date-start" class="form-control floating-label" placeholder="Pick-Up Date & Time" name="pckup_datetime">
                                                                  </div>
                                                              </div>
                                                          </div>
                                                          <div class="col-md-6 col-sm-6">
                                                              <div class="form-group">
                                                                  <input type="text" id="date-end" class="form-control floating-label" placeholder="Drop-Off Date & Time" name="drop_datetime">
                                                              </div>
                                                          </div>
                                                       </div>
                                                       <div class="row">
                                                           <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 ">
                                                                <div class="form-group sm_dspy">
                                                                   <input type="text" class="form-control floating-label"  placeholder="Phone Number" name="phone" maxlength="10" pattern="[0-9]{10}" >
                                                                </div>
                                                            </div>
                                                            <div class="buttons" data-animation="animated fadeInDown" data-animation-delay="0.8s">
            ...
            <div class="row">
                ...
                <div class="col-md-6 aboutus wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.5s">
                    ...
                    <div class="short-intro" style="margin-top:38px">
                        ...
                        <p align="justify">Journey  Wheels offers the simplest, easiest car and bike rental tariff in Vijayawada, Tirupati & Nellore. Find out with us and Find cheap rent a car and bike deals with Journeywheels Compare and save big on your next trip with discount Journeywheels car and bike rentals today. Journeywheels is targeted towards the segment of urban dwellers who don't want to own a car and bike, so, the company has launched , which allows consumers to unlock the cars and bikes through an app and can pick up the car/bike and drop them off at various points across your neighbourhood.</p> <p>If you can’t find your keys, simply use your smartphone. If you can’t find your phone, use your car keys.</p>
   ...
   <!-- OUR VEHICEL -->
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="download-info"><br/><br/>
                        ...
                        <h2>iPHONE, iPAD & ANDROID <small>Coming Soon</small></h2>
    ...
    <section >
        ...
        <div class="testimonials center black1 hidden-xs" style="background:url(images/testimonials.png) 50% 100% no-repeat;overflow:hidden;color:#fff;">
   ...
   <h6 class="wow fadeInDown"></h6>
                ...
                <h6 class="wow fadeInDown" ><i class="fa fa-quote-left"></i>Wow,
			Journey Wheels is outstanding!</h6>
                <p class="wow fadeInUp">Journeywheels is targeted towards the segment of urban dwellers who don't want to own a car, so, the company has launched , which allows consumers to unlock bikes through an app and can pick up the car/bike and drop them off at various points across your neighbourhood.</p>
                <p class="meta wow fadeInUp">-Bharath Kumar, Tirupati</p>
            </div>
			
			  <div class="wrap hidden-md hidden-lg hidden-sm">

                <h6 class="wow fadeInDown" ><i class="fa fa-quote-left"></i>Wow,
<br/>			<span class="" id="jourywhls-txt-siz-indx">	Journey Wheels</span> <br/> is <br/>outstanding!</h6>
                <p class="wow fadeInUp">Journeywheels is targeted towards the segment of urban dwellers who don't want to own a car, so, the company has launched , which allows consumers to unlock bikes through an app and can pick up the car/bike and drop them off at various points across your neighbourhood.</p>
                <p class="meta wow fadeInUp">-Bharath Kumar, Tirupati</p>
            </div>
        </div>
