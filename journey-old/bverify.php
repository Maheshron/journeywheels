...
if ($success === true)
{
    ...
    $loc='Vizag';
        ...
        $drop_location=$_SESSION['drop_location'];
        $drop_datetime=$_SESSION['drop_datetime'];
         $get_customer = "select * from bicycles WHERE id='$product_id'";
    ...
    $product_img = $row['product_img'];
        ...
        VALUES ('$o_id','$idd','$uid','$product_title','$product_id','$pick_location','$pick_datetime','$drop_location','$drop_datetime',NOW(),'$amount','$email','$contact','$name','$location','$rent','$tax','$tax1')";
          ...
          <td align="center" valign="top" class="body_info_content">
            <table width="100%" border="0" cellspacing="0" cellpadding="20">
              <tr>
                <td valign="top">
                  <h2 style="color: black; font-size: 20px; text-align: center;">TERMS & CONDITIONS</h2>
                  <p style="color: black; font-size: 14px; line-height:5px; text-align: left;">1.Speed limit: 80/hr.</p>
                  <p style="color: black; font-size: 14px; line-height: 5px; text-align: left;">2.Driving License will be verified in original.</p>
                   <p style="color: black; font-size: 14px; line-height: 5px; text-align: left;">3.One complimentary helmet will be provided with the bike.</p>   
                    <p style="color: black; font-size: 14px; line-height: 5px; text-align: left;">4.Fuel charges are not included.</p>
                </td>
              </tr>
               <tr>
                  <td valign="top">
