...
if($loc==1){
 ...
 if(isset($_POST['book'])){
                                  ...
                                  $id=$_POST["id"];
                                                 ...
                                                 echo "<script>window.location='carbooking.php?pick_loc=$pick_loc&pick_datetime=$pick_datetime&id=$id&drop_loc= $drop_loc&drop_datetime=$drop_datetime&location=$loc'</script>";
...
$d2=$date->format('Y-m-d H:i');
                                        ...
                                        if ($message ==12 || $message ==24) {
                                            ...
                                            echo "<script>window.location='carproducts.php?pick_loc=$f_pick_loc&pick_datetime=$pickupdatetime&drop_loc=$f_drop_loc&drop_datetime=$dropdatetime&location=$loc'</script>";

                                        }else {
                                           
                                            $error="Please Select 12 OR 24 hours For Booking";
                                       }
  ...
  <center class="text-center bloack-center"><ul id="myTabs" class="nav nav-pills nav-pill-styl" role="tablist" data-tabs="tabs">
    ...
    <li class="hidden-xs"><a href="#low-high" data-toggle="tab">12 Hours</a></li>
    <li class="hidden-xs"><a href="#high-low" data-toggle="tab">24 Hours</a></li>
  </ul></center>
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane fade in active" id="relavance">
            <div class="">
                <?php
                  ...
                  if(isset($_GET['location']) && $loc==2) {
              
                    $pckup_loc=$_GET['pick_loc'];
               
                    $query = "SELECT * FROM cars where location=$loc and availability=0  ";
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                          ...
                          <div class="prdct-lst-styl row">
                            ...
                            <div class="col-md-12 col-xs-12 btn-bg"> 
                              <div class="">
                         <h5 class="bold"><span class="" id="prodct-pric-txt"> <i class="fa fa-inr"></i><?php echo $row["price"]; ?>/12Hrs </span> <span class=""><button class="pull-right btn prodct-btn-styl" name="book" type="submit">Book Now</button></span> </h5>
                  ...
                  if(isset($_GET['location']) && $loc==2) {
                    ...
                    $query = "SELECT * FROM cars where location=$loc and availability=1  ";
                    $result = mysqli_query($db, $query);
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                          ...
                          <div class="prdct-lst-styl row">
                            ...
                            <div class="col-md-12 col-xs-12 btn-bg"> 
                              <div class="">
                         <h5 class="bold"><span class="" id="prodct-pric-txt"> <i class="fa fa-inr"></i><?php echo $row["price"]; ?>/12Hrs </span> <span class=""><button class="pull-right btn prodct-btn-styl" name="book" type="submit" style="color:red" disabled>Sold Out</button></span> </h5>
            ...
            if($loc!=2){?>
                     ...
                     <h1 class="text-center">Available Soon</h1>
   ...
   <div role="tabpanel" class="tab-pane fade" id="low-high">
            <div class="">
                <?php
                  if(isset($_GET['location']) && $loc==2) {
                    $pckup_loc=$_GET['pick_loc'];
                    $query = "SELECT * FROM cars where location=$loc and availability=0 ORDER BY  price";
                    $result = mysqli_query($db, $query);
                    if (mysqli_num_rows($result) > 0) {
             ...
             if(isset($_GET['location']) && $loc==2) {
                    $pckup_loc=$_GET['pick_loc'];
                    $query = "SELECT * FROM cars where location=$loc and availability=1 ORDER BY  price";
                    $result = mysqli_query($db, $query);
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                          ...
                          <div class="prdct-lst-styl row">
                            ...
                            <div class="col-md-12 col-xs-12 btn-bg"> 
                              <div class="">
                         <h5 class="bold"><span class="" id="prodct-pric-txt"> <i class="fa fa-inr"></i><?php echo $row["price"]; ?>/12Hrs </span> <span class=""><button class="pull-right btn prodct-btn-styl"  name="book" type="submit" style="color:red" disabled>Book Now</button></span> </h5>
    ...
    <div role="tabpanel" class="tab-pane fade" id="high-low">
            <div class="">
                ...
                $pckup_loc=$_GET['pick_loc'];
                    ...
                    $query = "SELECT * FROM cars where location=$loc and availability=0 ORDER BY  price desc ";
                    $result = mysqli_query($db, $query);
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                          ...
                          <div class="prdct-lst-styl row">
                            ...
                            <div class="col-md-12 col-xs-12 btn-bg"> 
                              <div class="">
                         <h5 class="bold"><span class="" id="prodct-pric-txt"> <i class="fa fa-inr"></i><?php echo $row["price1"]; ?>/24Hrs </span> <span class=""><button class="pull-right btn prodct-btn-styl" name="book" type="submit">Book Now</button></span> </h5>
                ...
                $pckup_loc=$_GET['pick_loc'];
                    ...
                    $query = "SELECT * FROM cars where location=$loc and availability=1 ORDER BY  price desc ";
                    $result = mysqli_query($db, $query);
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                          ...
                          <div class="prdct-lst-styl row">
                            ...
                            <div class="col-md-12 col-xs-12 btn-bg"> 
                              <div class="">
                         <h5 class="bold"><span class="" id="prodct-pric-txt"> <i class="fa fa-inr"></i><?php echo $row["price1"]; ?>/24Hrs </span> <span class=""><button class="pull-right btn prodct-btn-styl" name="book" type="submit" style="color:red" disabled>Book Now</button></span> </h5>
