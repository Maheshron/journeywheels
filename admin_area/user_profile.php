...
<input type="text" name="admin_name" class="form-control" required value="<?php echo $admin_name; ?>" required="required">
...
<input type="text" name="admin_email" class="form-control" required value="<?php echo $admin_email; ?>" required="required">
...
<input type="text" name="admin_pass" class="form-control" required value="<?php echo $admin_pass; ?>" required="required">
...
<label class="col-md-3 control-label">Admin Contact Number </label>

<div class="col-md-6"><!-- col-md-6 Starts -->

<input type="text" name="admin_contact" class="form-control" pattern="[789][0-9]{9}" title="Mobile no. should be 10 digits numbers & start with 7,8,9" minlength="10" maxlength="10" placeholder="Mobile Number" value="<?php echo $admin_contact; ?>" required="required">
...
<br>
<img src="admin_images/<?Php echo $admin_image; ?>" width="70" height="70" required="required">
