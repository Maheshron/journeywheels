...
if(!isset($_SESSION['admin_email'])){
        ...
        <div class="col-lg-12"><!-- col-lg-12 Starts -->
            ...
            <ol class="breadcrumb"><!-- breadcrumb Starts -->
                ...
                <li class="active">
                    ...
                    <i class="fa fa-dashboard"> </i> Dashboard / Insert Bike
            ...
            <div class="panel panel-default"><!-- panel panel-default Starts -->
                ...
                <div class="panel-heading"><!-- panel-heading Starts -->
                    ...
                    <h3 class="panel-title">
                        ...
                        <i class="fa fa-money fa-fw"></i> Insert Bike
                        ...
                        <div class="row"><!-- row Starts -->
                          ...
                          <div class="col-md-6"><!-- col-md-6 Starts -->
                                ...
                                <div class="form-group" ><!-- form-group Starts -->
                                    ...
                                    <label class="control-label" > Bike Price  * </label>

                                       <input type="number" name="product_price" class="form-control" required="required" title="Enter the value in number ">

                                </div><!-- form-group Ends -->
                                
                                <div class="form-group" ><!-- form-group Starts -->

                                    <label class="control-label"> Bike Location* </label>
                                    ...
                                    <select type="text" name="loc" class="form-control" required="required">
                                        ...
                                        <option value="9">Ananthapuram</option>
                                ...
                                <div class="form-group" ><!-- form-group Starts -->
                                    ...
                                    <label class="control-label" > Bike Image *  </label>
                                ...
                                <div class="form-group" ><!-- form-group Starts -->
                                    ...
                                    <label class="control-label" > Bike Availability* </label>
                                ...
                                <div class="form-group" ><!-- form-group Starts -->
                                    ...
                                    <input type="submit" name="submit" value="Insert Bike" class="btn btn-primary form-control" >
    ...
    if(isset($_POST['submit'])){
        ...
        $insert_product = "insert into products (product_title,product_img,price,cat_id,location,availability,kmlimit,excess) values ('$product_title','$product_img','$product_price','$catid','$loc',' $available','$p_kmlimit','$p_excess')";
