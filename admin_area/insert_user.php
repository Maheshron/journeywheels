...
<input type="email" name="admin_email" class="form-control" required="required" autocomplete="off">
...
<input type="text" name="admin_contact" class="form-control" pattern="[789][0-9]{9}" title="Only numbers allowed , should be 10 digits & start with 7,8,9" minlength="10" maxlength="10" placeholder="Mobile Number" required="required">
...
<input type="file" name="admin_image" class="form-control" required="required">
...
echo "<script>alert('Admin Profile Inserted successfully')</script>";
