...
<td class="bg-info"> <?php echo $p_cat_title; ?> </td>

<td class="bg-info">Parent</td>
<td class="bg-info">
...
<!--            <td> --><?php //echo $i; ?><!-- </td>-->
            ...
            <td> <?php echo $child['p_cat_title']; ?> </td>

            <td><?php echo $p_cat_title; ?></td>
            <td>

                <a href="index.php?delete_p_cat=<?php echo $child['$p_cat_id']; ?>">
            ...
            <td>
                ...
                <a href="index.php?edit_p_cat=<?php echo $child['$p_cat_id']; ?>">
