...
<head>
    ...
    <!-- PAGE TITLE -->
    <title>Enter Mobile Number | JourneyWheels | Bike Rental Services</title>
                    ...
                    <div class="col-md-7">
                        <div class="panel panel-default sidebar-menu" style="box-shadow: 0 2px 2px 0 rgba(0,0,0,0.14), 0 1px 5px 0 rgba(0,0,0,0.12), 0 3px 1px -2px rgba(0,0,0,0.2);"><!-- panel panel-default sidebar-menu Starts -->
                           <div class="panel-heading text-center" style="background:#ffb735;">
                                <h5 id='p_title' >ENTER YOUR MOBILE NUMBER</h5>
                            </div>
                             <div class="panel-body customeracnt" >
								<form class="log" method="post" action="">
									<div class="form-group  is-empty">
                                        <label>Mobile *</label>
                                        <input type="text" class="form-control" name="rmobile" pattern="[6789][0-9]{9}" title="Mobile no. should be 10 digit &amp; start with 6,7,8,9" minlength="10" maxlength="10" placeholder="Mobile Number" style="border-radius:5px; height:35px;background:#f6f6f6" required="required">
                                    </div>
									
                                    <div class="form-group text-center">
										<input type="submit" class="btn  btn-primary" name="send_otp" value="Send OTP">
									</div>
								</form>
                  <?php 
if(isset($_POST['send_otp'])) 
{
  ...
  $sendTo = $_POST['rmobile'];
  $query="SELECT * FROM `users` WHERE `mobile`='$sendTo'";
  ...
  else
  {
      ...
      $msg="Dear Customer, OTP to activate your account for Journey Wheels is :".$otp;
      $message=urlencode($msg);
      $sendTo = $_POST['rmobile'];
      $mobile=urlencode($sendTo);
      $_SESSION["mobile"]=$mobile;
      $messageUrl="http://bulksms.mysmsmantra.com/WebSMS/SMSAPI.jsp?username=JNYWLS&password=360806203&sendername=JNYWLS&mobileno=91".$mobile."&message=".$message; 
