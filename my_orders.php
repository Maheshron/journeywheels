...
<div id="wide-desktop">
   ...
   ?>
              ...
              <div class="col-md-12">
                 <div class="boxaccount " ><!-- box Starts -->
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="panel-heading text-center" style="background:#ffb735"><h4 id='p_title' >MY BOOKINGS</h4></div>
    ...
    $location='Vizag';
				       ...
				       <tr>
				       				<td class="text-center"><p><?php echo $row["razorpay_order_id"]; ?></p></td>
				       				<td class="text-center"><p><?php echo $row["vehicle_title"]; ?></p></td>
				       				<td class="text-center"><p><?php echo $row["pick_datetime"]; ?><br>To<br><?php echo $row["drop_datetime"]; ?></p></td>
				       				<td class="text-center"><p><?php echo $row["location"]; ?></p></td>
				       				<td class="text-center"><p>Rs <?php echo $row["amount"]; ?></p></td>
				       				<!--<td class="text-center" style="color:red;font-weight:bold">-->
				       				<!--    <button type="submit" name="delete" class="prem"   style="background-color: transparent;border: none;color:red;outline:none">-->
