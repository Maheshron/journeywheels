...
if(isset($_POST['categoryId'])) {
    ...
    if($categoryId == 7){
      echo "<option value=''>Pick-Up Kakinada Location</option>";
      echo "<option value='Journey Wheels Office'>Kakinada Journey Wheels Office</option>";
       echo "<option value='Railway Station'>Railway Station</option>";
         echo "<option value='Bus Stand'>Bus Stand</option>";
      }
...
if(isset($_POST['categoryId1'])) {
    ...
    if($categoryId1 == 7){
      echo "<option value=''>Drop-Off Kakinada Location</option>";
      echo "<option value='Journey Wheels Office'>Journey Wheels kakinada office Office</option>";
       echo "<option value='Railway Station'>Railway Station</option>";
         echo "<option value='Bus Stand'>Bus Stand</option>";
      }
