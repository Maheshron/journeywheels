...
if($loc==1){
 ...
 if(isset($_POST['book'])){
                                  ...
                                  $id=$_POST["id"];
                                                 ...
                                                 echo "<script>window.location='bicyclebooking.php?pick_loc=$pick_loc&pick_datetime=$pick_datetime&id=$id&drop_loc= $drop_loc&drop_datetime=$drop_datetime&location=$loc'</script>";
            ...
            <div class="">
                <?php
                  ...
                  if(isset($_GET['location'])) {
                    ...
                    $query = "SELECT * FROM bicycles where location=$loc and availability=0  ";
   ...
   <div role="tabpanel" class="tab-pane fade" id="low-high">
            <div class="">
                <?php
                  if(isset($_GET['location'])) {
                    $pckup_loc=$_GET['pick_loc'];
                    $query = "SELECT * FROM bicycles where location=$loc and availability=0 ORDER BY  price";
                    $result = mysqli_query($db, $query);
                    if (mysqli_num_rows($result) > 0) {
    ...
    <div role="tabpanel" class="tab-pane fade" id="high-low">
            <div class="">
                ...
                $pckup_loc=$_GET['pick_loc'];
                    ...
                    $query = "SELECT * FROM bicycles where location=$loc and availability=0 ORDER BY  price desc ";
                    $result = mysqli_query($db, $query);
                    if (mysqli_num_rows($result) > 0) {
